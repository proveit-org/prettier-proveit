        ...
        return(
            <AUX>
                ...
                <div className="container">
                            ...
                            <div className="custom-form">
                                ...
                                <form method="post"  name="contact-form" id="contact-form">
                                        <div className="row">
                                            ...
                                            <div className="col-lg-6 mt-3">
                                                <input type="text" id="lname" value={this.state.lname} onChange={this.handleChangeLname} className="form-control" placeholder="Last name" />
                                                <span id="err">{this.state.name_err}</span>
                                            </div>
                                        ...
                                        <div className="mt-4 text-center">
                                            <input type="button" id="submit" name="send" onClick={this.handleSubmit1} className="submitBnt btn btn-custom" value="Subscribe" />
                    ...
                    <div className="row mt-3 pt-5 pb-2">
                        <div className="col-md-12">
                            <div className="text-white footer-alt">
                                <div className="float-left">
                                    <p className="copyright-desc pb-0">2019 © PROVEIT. All Rights Reserved</p>
                                </div>
                                <div className="float-right">
                                    <ul className="list-inline social pb-0">
                                        ...
                                        <li className="list-inline-item pl-2"><Link to="#" className="text-white"><i className="mdi mdi-git"></i></Link></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
