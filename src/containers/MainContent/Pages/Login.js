                        ...
                        <div className="container-fluid">
                            <div className="col-lg-12">
                                <div className="home-icon">
                                    <Link to="index_1" onClick={()=>this.props.UpdateLoginAgain()}  className="text-white"><i id="my_icon" className="mdi mdi-home"></i></Link>
                                </div>
                            </div>
                        </div>
                    </section>
                                    ...
                                    <div className="row justify-content-center mt-4">
                                        <div className="col-lg-4">
                                            <div className="text-center">
                                                <h1 className="text-white">ProveIT</h1>
                                                <p className="text-white-50 text-center">Sign in to continue to ProveIT.</p>
                                            </div>
